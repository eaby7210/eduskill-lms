...
export default function Cart({ h, w, indicator, count }) {
  return (
    <div className="indicator mx-2">
      {indicator && (
        <div className="indicator-item badge badge-sm badge-secondary">
      ...
      >
        ...
        <g id="SVGRepo_iconCarrier">
          <path
            ...
            className="stroke-[1.5] stroke-primary"
            strokeLinecap="round"
            strokeLinejoin="round"
          ></path>
          <path
